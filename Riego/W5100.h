...
struct sRELE Rele [] = {  {0, LED_BUILTIN , "LED-EXT", HIGH, LOW, KEEP, true},
                          {1, 22 , "RELE1-EXT", LOW, HIGH, SETOFF, true},
                          {2, 24 , "RELE2-EXT", LOW, HIGH, SETOFF, true},
                          {3, 26 , "RELE3-EXT", LOW, HIGH, SETOFF, true},
                          {4, 28 , "RELE4-EXT", LOW, HIGH, SETOFF, true},
                          {5, 30 , "RELE5-EXT", LOW, HIGH, SETOFF, true},
                          {6, 32 , "RELE6-EXT", LOW, HIGH, SETOFF, true},
                          {7, 34 , "RELE7-EXT", LOW, HIGH, SETOFF, true},
                          {8, 36 , "RELE8-EXT", LOW, HIGH, SETOFF, true}
                       };
